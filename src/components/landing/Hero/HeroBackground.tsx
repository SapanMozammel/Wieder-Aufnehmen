	...
	return (
		<React.Fragment>
			...
			<div
				...
				<div className="absolute w-256 max-w-full aspect-square top-1/2 left-1/2 bg-radial from-info/50 via-info/15 via-40% to-transparent to-60% -translate-x-1/2 -translate-y-1/2"></div>
			</div>
		</React.Fragment>
	);
};
